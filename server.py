...
def broadcast_data (message):
 ...
 # Main Method that execute on the First
if __name__ == "__main__":
    ...
    try:
        ...
        print 'Please enter proper port Abady94'
        sys.exit()
    ...
    server_socket.bind(("127.0.0.1", PORT))    #When you used local So keep in mind your Ip will 127.0.0.1
